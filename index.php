 ...
 * 4.1. Alternativly, use &profile= to switch configuration!
...
if(file_exists($XF_DEFAULT_PROFILE)){require_once($XF_DEFAULT_PROFILE);}
...
if(file_exists($XF_CUSTOM_PROFILE)){ require_once($XF_CUSTOM_PROFILE);}
...
0		$serverApplicationClassName,
1		$clientApplicationName,
2		$clientDirectory,
3		$libOffset,
4		$logDirectory,
5		$xcvDataRoot,
